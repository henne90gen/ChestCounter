...
public class ChestServiceTest {
    ...
    public void getItemCountsWorksByLabel() {
        ...
        Map<ChestSearchResult.Key, ChestSearchResult.Value> byLabel = searchResult.byLabel;
        assertEquals(2, byLabel.size());

        assertTrue(byLabel.containsKey(ChestSearchResult.keyLabel("TestChest")));
        Map<String, Integer> chestResult = byLabel.get(ChestSearchResult.keyLabel("TestChest")).items;
        assertTrue(chestResult.containsKey("Sand"));
        assertEquals(new Integer(64), chestResult.get("Sand"));

        assertTrue(byLabel.containsKey(ChestSearchResult.keyLabel("AnotherChest")));
        chestResult = byLabel.get(ChestSearchResult.keyLabel("AnotherChest")).items;
        assertTrue(chestResult.containsKey("Sand"));
    ...
    public void getItemCountsWorksById() {
        ...
        ChestSearchResult searchResult = chestService.getItemCounts(worldID, "sa");
        assertNotNull(searchResult);
        Map<ChestSearchResult.Key, ChestSearchResult.Value> byId = searchResult.byId;
        assertEquals(3, byId.size());

        assertTrue(byId.containsKey(ChestSearchResult.keyId("1,2,3")));
        Map<String, Integer> chestResult = byId.get(ChestSearchResult.keyId("1,2,3")).items;
        assertTrue(chestResult.containsKey("Sand"));
        assertEquals(new Integer(32), chestResult.get("Sand"));

        assertTrue(byId.containsKey(ChestSearchResult.keyId("1,2,4")));
        chestResult = byId.get(ChestSearchResult.keyId("1,2,4")).items;
        assertTrue(chestResult.containsKey("Sand"));
        assertEquals(new Integer(32), chestResult.get("Sand"));

        assertTrue(byId.containsKey(ChestSearchResult.keyId("1,2,6")));
        chestResult = byId.get(ChestSearchResult.keyId("1,2,6")).items;
        assertTrue(chestResult.containsKey("Sand"));
        assertEquals(new Integer(25), chestResult.get("Sand"));
    }
